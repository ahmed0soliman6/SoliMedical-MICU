                ...
                <div className="flex items-center justify-between pb-3 border-b border-slate-200 dark:border-slate-800">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <button
                      ...
                      title={settings.notifications.isMuted ? (lang === 'ar' ? 'إلغاء الكتم' : 'Unmute') : (lang === 'ar' ? 'كتم التنبيهات الصوتية' : 'Mute Sounds')}
                    >
                      {settings.notifications.isMuted ? <VolumeX className="w-3.5 h-3.5" /> : <Volume2 className="w-3.5 h-3.5" />}
                    </button>
